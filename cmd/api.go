...
func loadFlagsFromRequestFile(requestFile string, schema bool, verbose bool, techniques []string, redirect bool) {
	...
	rawBody := rawRequestBody(string(content))
	...
	requesterWithBody(uri, proxy, userAgent, reqHeaders, bypassIP, folder, httpMethod, body, verbose, techniques, nobanner, rateLimit, timeout, redirect, randomAgent)
}

func rawRequestBody(content string) string {
